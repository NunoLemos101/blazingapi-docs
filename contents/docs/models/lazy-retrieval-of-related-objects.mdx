...
print(article.title)  # The related book is not loaded yet

print(article.book)  # The related book is loaded now
print(article.book.title)  # The book title is accessed from cache, no additional query is made
```
