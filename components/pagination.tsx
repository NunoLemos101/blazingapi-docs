...
export default function Pagination({path = "docs", routes = page_routes, pathname }: { path: string, routes: { title: string; href: string; }[], pathname: string }) {
